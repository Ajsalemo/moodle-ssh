...
# We're coping the default Moodle entrypoint from /opt/bitnami/scripts/moodle/entrypoint.sh and using this as our entrypoint to add SSH into it
# If we don't do this, SSH is not able to start normally (ex. ENTRYPOINT [".."])
echo "Starting SSH ..."
service ssh start
